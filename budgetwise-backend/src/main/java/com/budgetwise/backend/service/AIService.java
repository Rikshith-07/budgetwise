...
public class AIService {
    ...
    public AIService(DashboardService dashboardService,
                     @org.springframework.beans.factory.annotation.Value("${gemini.api.key:DISABLED}") String apiKey) {
    ...
    public String getBudgetAdvice(String clerkId) {
        ...
        if (client == null) {
            return "AI is disabled in local mode. Add gemini.api.key to enable.";
        }
